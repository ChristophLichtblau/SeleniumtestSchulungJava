...
public class TestRadioButtonSeleniumKursFireFox {
	...
	public void testRadiobutton() {
		...
		webElementePage.klickRadioButton2();
		webElementePage.klickRadioButton1();
		webElementePage.klickRadioButton3();
		

		// Assert
		assertEquals(webElementePage.getRadioButton1().isSelected(), false);
		assertEquals(webElementePage.getRadioButton2().isSelected(), false);
		assertEquals(webElementePage.getRadioButton3().isSelected(), true);
